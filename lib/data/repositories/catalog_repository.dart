...
class CatalogRepository {
  ...
  static final List<ProductVariant> products = [
    ...
    const ProductVariant(
      ...
      ingredients: ['Tepung Terigu', 'Ekstrak Caisim Segar Alami', 'Air Murni', 'Garam'],
    ...
    const ProductVariant(
      ...
      ingredients: ['Tepung Terigu', 'Ekstrak Wortel Segar', 'Air Murni', 'Garam'],
    ...
    const ProductVariant(
      ...
      ingredients: ['Tepung Terigu', 'Sari Buah Naga Merah Segar', 'Air Murni', 'Garam'],
