# 🍜 MieRen — Produsen Mie Kering Berbahan Sayuran Segar Alami

[![Flutter](https://img.shields.io/badge/Framework-Flutter-02569B?logo=flutter)](https://flutter.dev)
[![Web Ready](https://img.shields.io/badge/Platform-Web%20%7C%20Mobile-green)](https://flutter.dev/multi-platform)
...
## 📌 Daftar Isi
- [Tentang MieRen](#-tentang-mieren)
- [Keunggulan Utama](#-keunggulan-utama)
- [Katalog Varian Produk](#-katalog-varian-produk)
...
MieRen berfokus pada **kualitas premium, konsistensi produksi, dan formulasi ramah kesehatan**. Berbeda dengan mie komersial pada umumnya, produk MieRen tidak menggunakan pewarna buatan, bebas dari pengawet buatan, dan diracik **tanpa air abu (alkali water)** sehingga jauh lebih nyaman di pencernaan serta aman dikonsumsi oleh semua kalangan (anak-anak hingga dewasa).
...
| ⚖️ **Custom Gramasi Porsi Resto** | Gramasi standar **38 gram/pc** dan menerima penyesuaian porsi khusus (*custom*) sesuai standar sajian menu resto Anda. |
...
MieRen menghadirkan 5 varian mie sayur alami khas dengan karakter warna dan manfaat nutrisi yang unik:
...
- **Kategori**: Mie Klasik
- **Bahan Utama**: Tepung Terigu Pilihan, Air Murni, Garam Alami.
- **Keunggulan**: Mie kering putih alami tanpa bahan kimia, kenyal dan elastis, fleksibel digunakan sebagai bahan dasar berbagai resep mie nusantara dan oriental.

---

## 🤖 Fitur Web & Asisten Virtual (Chatbot)

Aplikasi web MieRen dilengkapi dengan fitur-fitur interaktif modern:
1. **Interactive Product Catalog**: Fitur pencarian instan (*live search*), filter kategori (Sayuran, Buah, Klasik), serta detail sheet produk lengkap dengan komposisi & *highlights*.
2. **MieRen Virtual Assistant**: Floating Chatbot interaktif di pojok kanan bawah yang siap menjawab pertanyaan seputar varian rasa, harga grosir, custom gramasi, sertifikasi, dan daya tahan produk secara dinamis.
3. **Integrasi WhatsApp Direct**: Tombol interaksi cepat untuk langsung berkonsultasi & memesan produk kepada pemilik (Bu Irene).
4. **Performance Optimized**: Seluruh gambar dioptimalkan (~120KB per aset) dengan *pre-caching* otomatis untuk navigasi super cepat tanpa *hitching*.
...
- **WhatsApp / Telepon**: [+62-8212-633-288](https://wa.me/628212633288)
